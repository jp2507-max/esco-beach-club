...
make_transparent("assets/app-icon.icon/Assets/icon.png", "assets/app-icon.icon/Assets/icon.png")
make_transparent("assets/android-icon.png", "assets/android-icon.png")
