...
| Date of birth               | Yes                  | Yes                     | No       | App functionality            | `profiles.date_of_birth`, optional profile editing                       |
...
- Camera access is used locally for member bill QR scanning. The current code does not upload captured images or frames.
...
- Keep date of birth disclosed as optional profile information for member personalization, not a required sign-up field.
