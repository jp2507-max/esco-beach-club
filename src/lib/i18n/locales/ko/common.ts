    ...
    privacy: {
      ...
      sections: {
        collection: {
          title: '수집하는 정보',
          body1:
            '회원 경험 운영에 필요한 계정 및 프로필 정보를 수집합니다. 여기에는 이메일 주소, 회원 식별자, 추천 코드, 프로필 이름, 생년월일, 그리고 예약 또는 프라이빗 이벤트 요청 양식에 사용자가 직접 입력한 기타 정보가 포함될 수 있습니다.',
          body2:
            '앱은 위치, 알림, 카메라 권한을 선택적으로 요청할 수 있습니다. 현재 릴리스에서는 위치가 현장 도착 기능을 위해 기기 내에서 사용되고, 알림은 로컬 리마인더와 오퍼에 사용되며, 카메라는 직원 QR 스캔 흐름에 한해 사용됩니다.',
        },
        use: {
          title: '정보 사용 방식',
          body1:
