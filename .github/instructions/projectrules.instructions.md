...
- `product.instructions.md` owns product positioning, member experience, and feature intent
- `styling-guidelines.instructions.md` owns Reanimated, worklets, gestures, motion tokens, and Reduced Motion behavior
- `Uniwind-styling.instructions.md` owns Uniwind, theming, wrapper imports, token usage, and `className` rules
...
- Follow `Uniwind-styling.instructions.md` for theme tokens, wrapper imports, `className` stability, and `cn` forwarding
- Follow `styling-guidelines.instructions.md` for Reanimated, gestures, worklets, and motion behavior
