...
- Follow `styling-guidelines.instructions.md` for Reduced Motion and animation runtime behavior.
...
- `styling-guidelines.instructions.md` owns animated styles, gestures, worklets, motion tokens, shared transitions, and cleanup rules.
