...
export const mockNewsFeed = [
  ...
  },
  {
    ...
    subtitle: 'Coastal Quartet performing smooth jazz on the main deck tonight.',
...
export const mockEvents = [
  ...
  },
  {
    ...
    date: 'Fri, Aug 30',
    location: 'Beach Front',
    image: 'https://images.unsplash.com/photo-1532767153700-ee38fa7ad4bb?w=200&h=200&fit=crop',
    attendees: 200,
    price: '$25',
    badge: 'MEMBERS ONLY',
    badgeColor: '#1A73E8',
...
export const eventCategories = ['All Events', 'Parties', 'Live Music', 'Wellness', 'Dining'];
