  ...
  return (
    <View className="flex-1 items-center justify-center">
      ...
      <View className="relative z-10 mx-5 min-w-[300px] items-center rounded-[20px] bg-card p-6 dark:bg-dark-bg-card">
        <Text className="mb-4 text-xl font-bold text-text dark:text-text-primary-dark">{t('modal.title')}</Text>
        ...
        <Pressable
          ...
          onPress={() => router.back()}
        >
          <Text className="text-center font-semibold text-white">{t('close')}</Text>
        </Pressable>
      </View>
